...
#define MyAppName "LunariumCoin Core"
#define MyAppPublisher "2022 LUNARIUMCOIN Core Developers"
#define MyAppURL "https://lunariumcoin.com"
#define MyAppExeName "lunariumcoin-qt.exe"
#define MyAppExtraData "https://explorer.lunariumCoin.net/bootstraps/XLN/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=LunariumCoinSetup
...
DefaultGroupName=LunariumCoin Core
...
[Files]
Source: ".\package\lunariumcoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\LunariumCoin\LunariumCoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\LunariumCoin\LunariumCoin-Qt,strDataDir|{userappdata}\LunariumCoin\}');
  Result := True;
end;
