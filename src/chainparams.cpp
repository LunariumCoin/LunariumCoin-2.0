...
public:
    CMainParams()
    {
        ...
        consensus.nXLNCoinSupplyMintHeight = 865600;
        consensus.nXLNCoinSupply = 61228800 * COIN;
        consensus.sXLNCoinSupplyMintAddress = "XGixMPzuBSWk3tsMtAgLjhCrvVaMvXXDGF";

        // spork keys
        consensus.strSporkPubKey = "04bea7041d489855e15e0f079a1ac97a8b3fdbf6a8b8dd66c02a5da92787ecc279baec4ae3a01c51ac1aefc3d4ca9d1528a83bb3979bb9824f809398912287b9c5";
        ...
        consensus.mBurnAddresses = {
           { "XXXXXXXXXXXXXXXXXXXXXXXXXXXXarcLhe", 0 }
        };
        ...
        vSeeds.push_back(CDNSSeedData("seeder", "seeder.lunariumcoin.com"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 12;   // lunariumcoin starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet lunariumcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet lunariumcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet lunariumcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet lunariumcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet lunariumcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.powLimit   = ~UINT256_ZERO >> 2;   // lunariumcoin starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
